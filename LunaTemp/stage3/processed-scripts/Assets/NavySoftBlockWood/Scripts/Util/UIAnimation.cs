...
using UnityEngine.UI;
	...
	public class UIAnimation : MonoBehaviour
	{
		...
		private void SetValue(object val)
		{
			switch (type)
			{
				...
				case Type.Height:
                    ...
                    break;
				case Type.Alpha:
					if (canvasGroup == null) Debug.LogError("Canvas Group Null: " + gameObject.name);
		...
		public static UIAnimation Color(Graphic graphic, [Bridge.Ref] Color to, float duration)
		{
			return CreateColorAnimation(graphic.gameObject, true, UnityEngine.Color.white, to, duration);
		}

		public static UIAnimation Color(Graphic graphic, [Bridge.Ref] Color from, [Bridge.Ref] Color to, float duration)
		{
		...
		private static UIAnimation CreateColorAnimation(GameObject gameObject, bool useCurrentFrom, [Bridge.Ref] Color from, [Bridge.Ref] Color to, float duration)
		{
