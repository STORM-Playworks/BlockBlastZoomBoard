...
public class LTDescr
{
    ...
    public LTDescr setOffset( [Bridge.Ref] Vector3 offset ){
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
	...
	public LTDescr setFromColor( [Bridge.Ref] Color col ){
	...
	private static void colorRecursive( Transform transform, [Bridge.Ref] Color toColor, bool useRecursion = true ){
	...
	private static void colorRecursiveSprite( Transform transform, [Bridge.Ref] Color toColor ){
		if(transform.childCount>0){
			foreach (Transform child in transform) {
	...
	private static void colorRecursive( RectTransform rectTransform, [Bridge.Ref] Color toColor ){
	...
	private static void textColorRecursive(Transform trans, [Bridge.Ref] Color toColor ){
	...
	*/
	public LTDescr setAxis( [Bridge.Ref] Vector3 axis ){
...
//		val = (val * val * val * val - 2f);
	...
	*/
	public LTDescr setTo( [Bridge.Ref] Vector3 to ){
		if(this.hasInitiliazed){
			this.to = to;
	...
	*/
	public LTDescr setFrom( [Bridge.Ref] Vector3 from ){
		if(this.trans){
			this.init();
		}
		this.from = from;
	...
	public LTDescr setDiff( [Bridge.Ref] Vector3 diff ){
		this.diff = diff;
		return this;
	}
	...
	*/
	...
	public LTDescr setRect( [Bridge.Ref] Rect rect ){
	...
	*/
	public LTDescr setPoint( [Bridge.Ref] Vector3 point ){
