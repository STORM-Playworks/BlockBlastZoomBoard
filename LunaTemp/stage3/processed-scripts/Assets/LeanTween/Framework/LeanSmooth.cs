...
public class LeanSmooth {
    ...
    */
    public static Vector3 damp([Bridge.Ref] Vector3 current, [Bridge.Ref] Vector3 target, ref Vector3 currentVelocity, float smoothTime, float maxSpeed = -1f, float deltaTime = -1f)
    {
    ...
    */
    public static Color damp([Bridge.Ref] Color current, [Bridge.Ref] Color target, ref Color currentVelocity, float smoothTime, float maxSpeed = -1f, float deltaTime = -1f)
    {
    ...
    * Debug.Log("current:"+transform.position);
    */
    public static Vector3 spring([Bridge.Ref] Vector3 current, [Bridge.Ref] Vector3 target, ref Vector3 currentVelocity, float smoothTime, float maxSpeed = -1f, float deltaTime = -1f, float friction = 2f, float accelRate = 0.5f)
    {
    ...
    * Debug.Log("current:"+fromColor);
    */
    public static Color spring([Bridge.Ref] Color current, [Bridge.Ref] Color target, ref Color currentVelocity, float smoothTime, float maxSpeed = -1f, float deltaTime = -1f, float friction = 2f, float accelRate = 0.5f)
    {
    ...
    * Debug.Log("current:"+transform.position);
    */
    public static Vector3 linear([Bridge.Ref] Vector3 current, [Bridge.Ref] Vector3 target, float moveSpeed, float deltaTime = -1f)
    {
    ...
    * Debug.Log("current:"+fromColor);
    */
    public static Color linear([Bridge.Ref] Color current, [Bridge.Ref] Color target, float moveSpeed)
    {
    ...
    * Debug.Log("current:"+transform.position);
    */
    public static Vector3 bounceOut([Bridge.Ref] Vector3 current, [Bridge.Ref] Vector3 target, ref Vector3 currentVelocity, float smoothTime, float maxSpeed = -1f, float deltaTime = -1f, float friction = 2f, float accelRate = 0.5f, float hitDamping = 0.9f)
    {
    ...
    * Debug.Log("current:" + fromColor);
    */
    public static Color bounceOut([Bridge.Ref] Color current, [Bridge.Ref] Color target, ref Color currentVelocity, float smoothTime, float maxSpeed = -1f, float deltaTime = -1f, float friction = 2f, float accelRate = 0.5f, float hitDamping = 0.9f)
    {
