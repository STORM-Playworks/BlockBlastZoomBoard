...
{
	public class UIMonoBehaviour : MonoHandler
	{
		#region Properties
		...
		public void Pulse([Bridge.Ref] Vector2 origScale, int pulseAmount, float pulseForce, float pulseAnimDuration)
		{
		...
		private IEnumerator StartPulse([Bridge.Ref] Vector2 origScale, int pulseAmount, float pulseForce, float pulseAnimDuration)
		{
